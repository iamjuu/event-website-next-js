...
export const Footer = () => {
  return (
    <footer className="bg-gray-900 text-gray-300 w-full mt-16 py-8 md:py-10 px-4 md:px-20">
      <div className="max-w-7xl mx-auto justify-center flex flex-col md:flex-row items-center gap-4 md:gap-6">
        <div className="text-gray-400 text-xs md:text-sm font-normal text-center md:text-left">
         Rights Reserved <span className="block md:inline mt-1 md:mt-0"> | Powered by DataHex</span>
        </div>
